...
This document provides a description of the hardware, firmware and software required to use multiple boards to control up to 4 qubits per board (4 drives + 4 Bias Flux + 2 RF Flux) using Qick and tProc_v1.
