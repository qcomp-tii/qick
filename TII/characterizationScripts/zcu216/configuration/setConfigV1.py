#
# Config script for tprocV1
#
from qick import *
from qick.averager_program import AveragerProgram, NDAveragerProgram, QickSweep, merge_sweeps
...
def set_sweetspots():
    tidac.set_bias(channel_cfg["DAC_bias"][0], bias_value=qubit_cfg["Q6"]["sweetspot"])
    tidac.set_bias(channel_cfg["DAC_bias"][1], bias_value=qubit_cfg["Q7"]["sweetspot"])
    tidac.set_bias(channel_cfg["DAC_bias"][2], bias_value=qubit_cfg["Q8"]["sweetspot"])
    tidac.set_bias(channel_cfg["DAC_bias"][3], bias_value=qubit_cfg["Q9"]["sweetspot"])
